...
#define GLCD_CTRL2_PORT				PORTD
#define GLCD_CTRL2_PIN				PIND
#define GLCD_CTRL2_DDR				DDRD
#define GLCD_RESET				PD2 /* need to be solved case by case and...*/
#define GLCD_FS					PD3 /* ...here too. Done. */
